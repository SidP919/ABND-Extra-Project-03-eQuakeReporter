package com.example.android.equakereporter.utility;

import android.util.Log;

import com.example.android.equakereporter.EarthQuake;
    ...
    public static ArrayList<EarthQuake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < featuresArray.length(); i++) {
                ...
                JSONObject featuresRoot = featuresArray.getJSONObject(i);

                JSONObject propertiesRoot = featuresRoot.getJSONObject("properties");

                double mag = propertiesRoot.getDouble("mag");

                String place = propertiesRoot.getString("place");

                Date d = new Date(propertiesRoot.getLong("time"));
                SimpleDateFormat simpleDateFormat1 = new SimpleDateFormat("MMM dd, yyyy");
                SimpleDateFormat simpleDateFormat2 = new SimpleDateFormat("hh:mm a");
                String date = simpleDateFormat1.format(d) + "\n" + simpleDateFormat2.format(d);
